...
package com.alacrity.openingdesign.messageportlet.model.service.messaging;

import com.alacrity.openingdesign.messageportlet.model.service.ClpSerializer;
...
public class ClpMessageListener implements MessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			SKQuestionLocalServiceUtil.clearService();
		}
	}
